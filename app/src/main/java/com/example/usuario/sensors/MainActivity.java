...
public class MainActivity extends ActionBarActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                switch (progress){
                    case 0:
                        Toast.makeText(MainActivity.this, "Set: SENSOR_DELAY_NORMAL", Toast.LENGTH_SHORT).show();
                        mSensorElection = SensorManager.SENSOR_DELAY_NORMAL;
                        break;
                    case 1:
                        Toast.makeText(MainActivity.this, "Set: SENSOR_DELAY_FASTEST", Toast.LENGTH_SHORT).show();
                        mSensorElection = SensorManager.SENSOR_DELAY_FASTEST;
                        break;
                    case 2:
                        Toast.makeText(MainActivity.this, "Set: SENSOR_DELAY_GAME", Toast.LENGTH_SHORT).show();
                        mSensorElection = SensorManager.SENSOR_DELAY_GAME;
                        break;
                    case 3:
                        Toast.makeText(MainActivity.this, "Set: SENSOR_DELAY_UI", Toast.LENGTH_SHORT).show();
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        double acceleration = Math.sqrt(pow(x,2) + pow(y,2) + pow(z,2));
